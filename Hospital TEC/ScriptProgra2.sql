...
Insert into PublicEmployee (Name1, Name2, LastName1, LastName2, Area, EType, EntryDate, CenterID) values ('Maria','Celeste','Salinas','Medina','Ginecología','Doctora','01-06-2001',2)
...
--Table Diagnosis
Insert into Diagnosis (DiagnosisID, DName, DLevel, Observation) values ('D001','Infección','bajo','Paciente presenta dolor en el vientre')
Insert into Diagnosis (DiagnosisID, DName, DLevel, Observation) values ('D002','Tumor','medio','')
Insert into Diagnosis (DiagnosisID, DName, DLevel, Observation) values ('D003','Gastritits','regular','Paciente presenta dolor abdominal')
