...
Insert into Appointments (AppointmentID, ATime, ADate, Observation, Area, PatientID) values ('A001','1:00 pm','02-02-2020','','Ginecología', 801290187);
Insert into Appointments (AppointmentID, ATime, ADate, Observation, Area, PatientID) values ('A002','5:00 pm','03-11-2019','','Oncología', 208100002);
Insert into Appointments (AppointmentID, ATime, ADate, Observation, Area, PatientID) values ('A003','8:00 am','06-09-2018','Dolor estomacal','Emergencias', 568956589);
...
Insert into Hospitalization (HospitalizationID, Name1, Name2, LastName1, LastName2, StartDate, EndDate, Speciality, CenterID, DiagnosisID, PatientID, EmployeeID) values ('H002','Clara','','Rojas','Treminio','02-02-2020','02-10-2020','Infecciones',2,'D001',801290187,90122797);
