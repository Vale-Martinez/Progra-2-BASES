...
--Table Patients 
Insert into Patients (PatientID,Name1, Name2, LastName1, LastName2, BloodType, BirthDate, Nationality, Province, Canton, District, Signals, CenterID) values (208100002,'Federico','','Alfaro','Campos','B-','06-16-2009','Costarricense','Alajuela','Atenas','San Isidro', 'Casa Amarilla', 1);
Insert into Patients (PatientID,Name1, Name2, LastName1, LastName2, BloodType, BirthDate, Nationality, Province, Canton, District, Signals, CenterID) values (801290187,'Laura','Nathalya','Barrera','Tovar','O-','02-15-2003','Costarricense','Heredia','Barva','San Pedro', 'Residencial', 2);
Insert into Patients (PatientID,Name1, Name2, LastName1, LastName2, BloodType, BirthDate, Nationality, Province, Canton, District, Signals, CenterID) values (568956589,'Alex','Andrés','Tijerino','','B+','03-27-2000','Costarricense','Puntarenas','Puntarenas','Acapulco', '', 2);
select * from Patients  ;

--Table Appointments REVISAR
Insert into Appointments (AppointmentID,AState, ATime, ADate, Observation, Area, PatientID) values ('A001','Registrada','1:00 pm','02-02-2020','','Ginecología', 801290187);
Insert into Appointments (AppointmentID,AState, ATime, ADate, Observation, Area, PatientID) values ('A002','Registrada','5:00 pm','03-11-2019','','Oncología', 208100002);
Insert into Appointments (AppointmentID,AState, ATime, ADate, Observation, Area, PatientID) values ('A003','Registrada','8:00 am','06-09-2018','Dolor estomacal','Emergencias', 568956589);
...
Insert into Hospitalization (HospitalizationID, Name1, Name2, LastName1, LastName2, StartDate, EndDate, Speciality, CenterID, DiagnosisID, PatientID, EmployeeID) values ('H001','José','Alejandro','Campos','Torres','06-09-2018','06-15-2019','General',3,'D003',208100002,123456789);
Insert into Hospitalization (HospitalizationID, Name1, Name2, LastName1, LastName2, StartDate, EndDate, Speciality, CenterID, DiagnosisID, PatientID, EmployeeID) values ('H002','Clara','','Rojas','Treminio','02-02-2020','02-10-2020','Infecciones',2,'D001',801290187,901220797);
...
Insert into Employee_Patient (PatientID, EmployeeID) values (208100002, 987654321);
Insert into Employee_Patient (PatientID, EmployeeID) values (801290187, 901220797);
Insert into Employee_Patient (PatientID, EmployeeID) values (568956589, 123456789);
select * from Employee_Patient;

--Table Patients_Phones REVISAR
Insert into Patients_Phones (PatientID, Phones) values (208100002, 85639562);
Insert into Patients_Phones (PatientID, Phones) values (208100002, 22569874);
Insert into Patients_Phones (PatientID, Phones) values (801290187, 22336655);
Insert into Patients_Phones (PatientID, Phones) values (801290187, 21487935);
Insert into Patients_Phones (PatientID, Phones) values (568956589, 89562314);
select * from Patients_Phones;

--Table Patients_Diagnosis 
Insert into Patients_Diagnosis (PatientID, DiagnosisID) values (801290187, 'D001');
Insert into Patients_Diagnosis (PatientID, DiagnosisID) values (208100002, 'D002');
Insert into Patients_Diagnosis (PatientID, DiagnosisID) values (568956589, 'D003');
